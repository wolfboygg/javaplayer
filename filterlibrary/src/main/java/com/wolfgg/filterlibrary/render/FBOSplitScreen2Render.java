...
public class FBOSplitScreen2Render extends BaseRender {

    public FBOSplitScreen2Render(Context context) {
        super(context);
    }
    ...
    public String loadFragmentShader() {
        return ShaderUtils.getRawResource(mContext, R.raw.fragment_shader_split_screen_2);
    }
}
